...
<link rel="stylesheet" href="<?= Url::asset('/plugins/summer/login/skins/tailwindsimple/assets/css/dist/backend.css'); ?>">
...
<style>
    :root {
        --primary: #34495E;
        --primary-dark: #273747;
        --primary-darker: #1b2530;
        --primary-darkest: #0e1319;
        --primary-light: #537496;
        --primary-lighter: #88a2bd;
        --primary-lightest: #c3d0de;
        --secondary: #E67E22;
        --secondary-dark: #b66015;
        --secondary-darker: #7b410e;
        --secondary-darkest: #3f2107;
        --secondary-light: #ec9e59;
        --secondary-lighter: #f2be90;
        --secondary-lightest: #f9dec7;
    }
</style>
